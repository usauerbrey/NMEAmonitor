...
// (2) Control over 3 - 6 digital input pins (internal pullups enabled)
...
// settings
  # define _LCDML_CONTROL_serial_enter           'r'
  # define _LCDML_CONTROL_serial_up              'u'
  # define _LCDML_CONTROL_serial_down            'd'
  # define _LCDML_CONTROL_serial_left            'l'
  # define _LCDML_CONTROL_serial_right           'R'
...
// settings
  #define _LCDML_CONTROL_digital_low_active      1    // (0 = low active (pullup), 1 = high active (pulldown) button
                                                      // http://playground.arduino.cc/CommonTopics/PullUpDownResistor
  #define _LCDML_CONTROL_digital_enable_quit     0    // 0=NO quit button
  #define _LCDML_CONTROL_digital_enable_lr       0    // 0=No right and left buttons
  #define _LCDML_CONTROL_digital_enter           PIN_ENTER    
  #define _LCDML_CONTROL_digital_up              PIN_UP
  #define _LCDML_CONTROL_digital_down            PIN_DOWN
